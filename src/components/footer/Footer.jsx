...
function Copyright() {
  ...
  return (
    <Typography variant="body2" color="textSecondary" align="center">
      {"Copyright © "}
      <Link color="inherit" href="https://www.linkedin.com/in/yann-dubois-88665992/">
        Yann Dubois
      </Link>{" "}
...
const Social = () => {
  ...
  const props = [
    ...
    { name: 'LinkedIn', icon: LinkedInIcon, link:"https://www.linkedin.com/in/yann-dubois-88665992/"},
  ...
  return(
    <Grid container justify="space-around" className={classes.container}>
      {props.map((network) => (
        <Grid xs={4} container spacing={6} alignItems="center" direction="row" justify="center">
            <Grid item >
            <Grid container alignItems="center" direction="row" justify="center" spacing={3} > 
              ...
              <Grid item>
            <Link color="inherit" href={network.link}><Grid item>{network.name}</Grid></Link>
            </Grid>
            </Grid>
            </Grid>
          </Grid>
